  ...
  return (
    <div className="flex min-h-[800px] w-full bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
          ...
          <div className="px-2 mg-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              <Image
                ...
                width={32}
                height={32}
                className="obhect-cover rounded-full mr-3"
              />
              <span className="font-medium">DiscoUp</span>
            </div>
        ...
        <div className="p-2 bg-[#292b2f] flex items-center]">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-[#b9bbbe] flex">@your_account</p>
          </div>
      ...
      <div className="flex-1 flex flex-col">
        {/* dm header */}
        <div className="h-16 bg-[#3639f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">DiscoUp</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            <PlusCircle className="mx-3 text-[#b9bbbe] hover:text-white cursor-not-allowd" />
            <input
              readOnly
              type="text"
              placeholder="Message @DiscoUp"
