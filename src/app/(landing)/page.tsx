        ...
        <MaxWidthWrapper classname="text-center">
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            ...
            <p className="text-base/7 text-gray-600 max-w-prose text-center text-pretty">
              DiscoUp in the easiest way to monitor your SaaS. Get instant
              notifications for{" "}
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg) + 1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-8 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-l-lg text-sm/6 text-gray-600 max-lg:text-center">
            ...
            <div className="relative max-lg:row-start-1">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg) + 1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-l-lg text-sm/6 text-gray-600 max-lg:text-center">
                    From new user signups to successful payments, DiscoUp
                    notifies you for all critical evenets in your SaaS
                  </p>
                </div>
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg) + 1px)] ">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-l-lg text-sm/6 text-gray-600 max-lg:text-center">
                    ...
                    email, a purchase amount or an excedeed quota.
                  </p>
                </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg) + 1px)] max-lg:rounded-b-[calc(2rem + 1px)] lg:rounded-r-[calc(2rem + 1px)]">
                <div className="px-8 pb-2 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-l-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Connect DiscoUp with your existing workflows in minutes and
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 ">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-950 text-center lg:text-left text-pretty">
                DiscoUp has been a game changer for me. I've been using it for
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-950 text-center lg:text-left text-pretty">
                Discord notification never was so satisfying lol, thanks,
                awesome tool to use to make everyday tasks easier and some vital
                stats to track
              </p>
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-sm text-gray-600">@nicojul</p>
                </div>
              </div>
            </div>
          </div>
